...
import com.androzic.plugin.locationshare.R;
...
public class FormattedSeekBarPreference extends Preference {
    ...
    public void onBindViewHolder(@NonNull PreferenceViewHolder holder) {
        ...
        mSeekBar = (SeekBar) holder.findViewById(androidx.preference.R.id.seekbar);
        mSeekBarValueTextView = (TextView) holder.findViewById(androidx.preference.R.id.seekbar_value);
